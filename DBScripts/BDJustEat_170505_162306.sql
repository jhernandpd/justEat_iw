...
create table "public"."restaurante" (
   ...
   "valoracion"  float8,
   "habilitado"  bool,
  primary key ("oid_restaurante")
);


-- Producto [ent2]
create table "public"."producto" (
   "oid_producto"  int4  not null,
...
create table "public"."tipo_comida" (
   "oid_tcomida"  int4  not null,
   "nombre"  varchar(255),
  primary key ("oid_tcomida")
);


-- Menu [ent4]
create table "public"."menu" (
   "oid_menu"  int4  not null,
   "nombre_menu"  varchar(255),
   "descripcion"  varchar(255),
   "precio"  float8,
   "descuento"  int4,
  primary key ("oid_menu")
);


-- Pedido [ent5]
create table "public"."pedido" (
   "oid_pedido"  int4  not null,
   "preciototal"  float8,
   "direccion"  varchar(255),
   "descuento"  float8,
...
create table "public"."opinion" (
   "oid_opinion"  int4  not null,
   "comentario"  varchar(255),
   "fecha"  timestamp,
   "valoracion"  int4,
  primary key ("oid_opinion")
);


-- Tipo_Producto [ent7]
create table "public"."tipo_producto" (
   "oid_tproducto"  int4  not null,
   "tipo"  varchar(255),
  primary key ("oid_tproducto")
);
...
alter table "public"."producto"   add constraint fk_producto_tipo_producto foreign key ("tipo_producto_oid") references "public"."tipo_producto" ("oid_tproducto");


-- Restaurante_Menu [rel11]
alter table "public"."menu"  add column  "restaurante_oid"  int4;
alter table "public"."menu"   add constraint fk_menu_restaurante foreign key ("restaurante_oid") references "public"."restaurante" ("oid_restaurante");


-- Restaurante_Opinion [rel2]
alter table "public"."opinion"  add column  "restaurante_oid"  int4;
alter table "public"."opinion"   add constraint fk_opinion_restaurante foreign key ("restaurante_oid") references "public"."restaurante" ("oid_restaurante");
...
alter table "public"."producto"   add constraint fk_producto_restaurante foreign key ("restaurante_oid") references "public"."restaurante" ("oid_restaurante");
...
alter table "public"."producto_menu"   add constraint fk_producto_menu_producto foreign key ("producto_oid") references "public"."producto" ("oid_producto");
alter table "public"."producto_menu"   add constraint fk_producto_menu_menu foreign key ("menu_oid") references "public"."menu" ("oid_menu");
...
alter table "public"."producto_pedido"   add constraint fk_producto_pedido_producto foreign key ("producto_oid") references "public"."producto" ("oid_producto");
alter table "public"."producto_pedido"   add constraint fk_producto_pedido_pedido foreign key ("pedido_oid") references "public"."pedido" ("oid_pedido");
...
alter table "public"."menu_pedido"   add constraint fk_menu_pedido_menu foreign key ("menu_oid") references "public"."menu" ("oid_menu");
alter table "public"."menu_pedido"   add constraint fk_menu_pedido_pedido foreign key ("pedido_oid") references "public"."pedido" ("oid_pedido");
...
alter table "public"."restaurante"   add constraint fk_restaurante_tipo_comida foreign key ("tipo_comida_oid") references "public"."tipo_comida" ("oid_tcomida");
